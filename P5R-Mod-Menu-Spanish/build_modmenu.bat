...
set PAKPACK="D:\Game Modding\Persona 5 Royal Modding\PAKTools\PAKPack.exe"
set COMPILER="D:\Game Modding\Persona 5 Royal Modding\AtlusScriptToolchain\AtlusScriptCompiler.exe"
...
%COMPILER% .\field\field.bf.flow    -Compile -OutFormat V3BE -Library P5R -Encoding P5R_EFIGS -Out "%OUTPUT_PATH%\field\field.bf" -Hook
%COMPILER% .\dungeon\dungeon.bf.flow -Compile -OutFormat V3BE -Library P5R -Encoding P5R_EFIGS -Out "%OUTPUT_PATH%\field\dungeon.bf" -Hook
%COMPILER% .\mementos\at_dng.bf.flow -Compile -OutFormat V3BE -Library P5R -Encoding P5R_EFIGS -Out "%OUTPUT_PATH%\field\at_dng.bf" -Hook
%COMPILER% .\script\field\fscr0150_002_100_hook.flow -Compile -OutFormat V3BE -Library P5 -Encoding P5R_EFIGS -Out "%OUTPUT_PATH%\script\field\fscr0150_002_100.bf" -Hook
